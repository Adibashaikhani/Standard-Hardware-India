...
const Dealership = () => {
  return (
    <div className="bg-slate-50 min-h-screen pt-6 pb-12 flex flex-col items-center">
      <div className="container mx-auto px-4 md:px-6 flex flex-wrap justify-center gap-6 max-w-6xl">
